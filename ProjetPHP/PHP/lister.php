                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="#">Liste des Apprenants</a></li>
                            <li class="#"><a href="listerpromo.php">Liste des Promo</a></li>
                        </ul>
                    ...
                    <form id="recherche-form" class="recherche-form" method="POST" action=<?= $_SERVER["PHP_SELF"] ?>>
                        ...
                        <div class="form-group" style="margin-bottom:10%; margin-top:-5%;">        
                            <div class="col-sm-offset-11 col-sm-10" >
                                <button type="submit" name="lister" class="btn btn-primary" style="background: teal;">Submit</button>
                            </div>
                        </div>
                    </form>
